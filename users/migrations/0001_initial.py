# Generated by Django 5.2.5 on 2025-09-08 11:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Egyesületi vezető', 'Egyesületi vezető'), ('Edző', 'Edző'), ('Sportoló', 'Sportoló'), ('Szülő', 'Szülő'), ('Szurkoló', 'Szurkoló')], max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Kosárlabda', 'Kosárlabda'), ('Bírkozás', 'Bírkozás'), ('Labdarúgás', 'Labdarúgás'), ('Kézilabda', 'Kézilabda'), ('Vízilabda', 'Vízilabda'), ('Röplabda', 'Röplabda'), ('Asztalitenisz', 'Asztalitenisz'), ('Úszás', 'Úszás')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sport', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.sport')),
